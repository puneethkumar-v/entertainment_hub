...
const renderItems = (currentPage, onClick) =>
  menu.map((id) => (
    <Link
      key={id}
      to={id === "Start" ? "browse" : id.toLowerCase().replace(" ", "")}
    >
      <button
        type="button"
        className="menu-item"
    ...
    <div className="header-content">
      <div className="header-left">
        ...
        <DropdownMenu
          ...
          onClick={onClick}
        />
        <div className="menu-items">{renderItems(currentPage, onClick)}</div>
      </div>
        ...
        <div className="header-rigth-items">
          ...
          <div className="header-avatar">
            <img
              src={user.avatar}
              alt="user avatar"
              // onClick={window.localStorage.removeItem("activeUser")}
            />
